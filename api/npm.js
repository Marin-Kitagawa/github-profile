...
import { renderNpmCard } from "../src/cards/npm.js";
import {
  CACHE_TTL,
  resolveCacheSeconds,
  setCacheHeaders,
...
import { fetchNpmStats } from "../src/fetchers/npm.js";
...
export default async (req, res) => {
  ...
  try {
    const npmData = await fetchNpmStats(username);
