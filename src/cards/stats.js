...
const renderStatsCard = (stats, options = {}) => {
  ...
  // Optional dark-mode colors resolved from a separate dark_theme parameter.
  const darkColors = dark_theme
    ? getCardColors({
  ...
  */
  ...
  // Inject per-card dark-mode overrides (stat text, icons, rank circle).
  if (darkColors) {
    card.setDarkCSS(`
      .stat { fill: ${darkColors.textColor} !important; }
      .icon { fill: ${darkColors.iconColor} !important; }
      .rank-text { fill: ${darkColors.textColor} !important; }
      .rank-circle-rim { stroke: ${darkColors.ringColor} !important; }
      .rank-circle { stroke: ${darkColors.ringColor} !important; }
    `);
  }
