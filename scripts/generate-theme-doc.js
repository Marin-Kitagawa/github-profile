...
const createRepoMdLink = (theme) => {
  return `\n[${theme}_repo]: https://github-profile.vercel.app/api/pin/?username=anuraghazra&repo=github-profile&cache_seconds=86400&theme=${theme}`;
};
const createStatMdLink = (theme) => {
  return `\n[${theme}]: https://github-profile.vercel.app/api?username=anuraghazra&show_icons=true&hide=contribs,prs&cache_seconds=86400&theme=${theme}`;
};
